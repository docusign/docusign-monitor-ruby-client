...
module DocuSign_Monitor
  class Aggregation
    attr_accessor :aggregation_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'aggregationName')
        self.aggregation_name = attributes[:'aggregationName']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          aggregation_name == o.aggregation_name
    end
